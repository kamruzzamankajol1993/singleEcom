                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('testimonial.store') }}"  method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control"  placeholder="Designation" name="desi" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-xxl-12 col-md-12">
                                    ...
                                    <small style="font-weight: 900;color:red;">Image Size:(110*110)px;format:png</small>
                                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                        ...
                        <div class="modal fade" id="modal-default{{ $allCategoryList->id }}">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('testimonial.update',$allCategoryList->id) }}"  method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-12 col-md-12">
                                                <div>
                                                    <label for="" class="form-label">Designation</label>
                                                    <input type="text" class="form-control" value="{{ $allCategoryList->desi }}" placeholder="Designation" name="desi" required>
                                                </div>
                                            </div>
                    ...
                    <form id="delete-form-{{ $allCategoryList->id }}" action="{{ route('testimonial.destroy',$allCategoryList->id) }}" method="POST" style="display: none;">
                      @method('DELETE')
                                                    @csrf
